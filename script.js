...
// ! indexof
let indexOfW = myString.indexOf("W");
...
let greeting = "Hello";
let name03 = "Alice";
let fullGreeting = greeting.concat(", ", name03, "!");

// tempaltes literals
let name04 = "John";
let age = 30;
let greet = `My name is ${name04} and I am ${age} years old.`;
